        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantInstitucionId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Tenants_TenantInstitucionId",
                        column: x => x.TenantInstitucionId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantInstitucionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Edificios", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Edificios_Tenants_TenantInstitucionId",
                        column: x => x.TenantInstitucionId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_TenantInstitucionId",
                table: "AspNetUsers",
                column: "TenantInstitucionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Edificios_TenantInstitucionId",
                table: "Edificios",
                column: "TenantInstitucionId");
